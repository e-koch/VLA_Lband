...
The path to the extract_from_log.py file should be changed.
The script expects the results are in individual channel folders, where each
contains ONLY 1 casa log file.

CALL:
python get_clean_results_template.py PATH_TO_CHANNELS CLEAN_results_file.csv
COMMON_STRING_PREFIX True/False(show table in browser)
'''
