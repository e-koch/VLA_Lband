...
logprint("Starting EVLA_pipe_flag_baddeformatters.py", logfileout='logs/flag_baddeformatters.log')
...
logprint ("Finished EVLA_pipe_flag_baddeformatters.py", logfileout='logs/flag_baddeformatters.log')
