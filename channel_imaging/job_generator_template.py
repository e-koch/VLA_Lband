...
Paths need to be altered to the system being run on. The offset in the
numbering between the MS channels and the mask/model channels must also be
changed.
'''
...
model_channel_name = \
    os.path.join(data_directory,
                 "model_channels/M33_14B-088_HI_model_channel_{}.image")
mask_channel_name = \
    os.path.join(data_directory,
                 "mask_channels/M33_14B-088_HI_mask_channel_{}.image")
