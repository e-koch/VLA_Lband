...
total_spectrum_hi.hdu.writeto(fourteenB_HI_data_wGBT_path("stacked_spectra/rotation_stacked.fits",
                                                     no_check=True),
                              overwrite=True)
...
total_spectrum_hi_cent.hdu.writeto(fourteenB_HI_data_wGBT_path("stacked_spectra/centroid_stacked.fits",
                                                               no_check=True),
                                   overwrite=True)
...
total_spectrum_hi_peakvel.hdu.writeto(fourteenB_HI_data_wGBT_path("stacked_spectra/peakvel_stacked.fits",
                                                                  no_check=True),
                                      overwrite=True)
