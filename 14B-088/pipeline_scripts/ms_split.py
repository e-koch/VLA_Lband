...
if split_lines:
    ...
    source_path = os.path.expanduser("~/ownCloud/code_development/VLA_Lband/14B-088/pipeline_scripts/cont.dat")
    copyfile(source_path, lines_folder + "/cont.dat")

    # Check for a flag template and copy if in the repo
    # Naming conventions is 14B-088_month_day_year_lines_flags.txt
    flag_filename = "{}_lines_flags.txt".format(parentdir)
    flag_path = os.path.expanduser("~/ownCloud/code_development/VLA_Lband/14B-088/pipeline_scripts/track_flagging")
