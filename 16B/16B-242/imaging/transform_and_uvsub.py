...
out_vis = "16B-242_{0}_spw_{1}_LSRK.ms"\
    .format(linespw_dict[spw_num][0], spw_num)

out_vis_mms = "16B-242_{0}_spw_{1}_LSRK.mms"\
    .format(linespw_dict[spw_num][0], spw_num)
...
out_vis_cs = "16B-242_{0}_spw_{1}_LSRK.ms.contsub"\
    .format(linespw_dict[spw_num][0], spw_num)

out_mms_vis_cs = "16B-242_{0}_spw_{1}_LSRK.mms.contsub"\
     .format(linespw_dict[spw_num][0], spw_num)
...
uvcontsub(vis=out_vis_mms,
          fitspw='0:{}'.format(linespw_242_uvsub[spw_num]),
