...
call("python {0} {1} {2} {3}".format(diskfit_script, diskfit_params,
                                     output_path, moment1_name), shell=True)
...
execfile(c_hi_analysispath("residual_velocity_surface_figure.py"))
...
execfile(c_hi_analysispath("rotsub_channels_figure.py"))
...
execfile(c_hi_analysispath("co_comparison/co_radial_profiles.py"))

execfile(c_hi_analysispath("co_comparison/co_veldisp_profiles.py"))
