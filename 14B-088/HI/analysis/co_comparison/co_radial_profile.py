...
mom0_hi = fits.open(os.path.join(direc_hi,
                                 "M33_14B-088_HI.clean.image.pbcov_gt_0.3_masked.mom0.fits"))[0]
hi_cube = SpectralCube.read(os.path.join(direc_hi,
...
# Overplot the Krumholz model with a few different clumping factors. Theoretically,
# c -> 1 at a resolution of 100 pc. but I'm finding a better match when c=4-6.
# The model is supposed to take metallicity into account, but maybe the gradient is
# causing some issues? Schruba+11 finds c~2 for their entire sample, with a
# lot of scatter
