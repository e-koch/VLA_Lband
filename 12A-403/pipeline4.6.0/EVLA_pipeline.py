...
if casa_version < 460:
    sys.exit("Your CASA version is "+casadef.casa_version+", please re-start using CASA 4.6.0")
if casa_version > 460:
    sys.exit("Your CASA version is "+casadef.casa_version+", please re-start using CASA 4.6.0")

# Define location of pipeline
from paths import twelveA_pipe_path
pipepath = twelveA_pipe_path
...
# OPTIONALLY MAKE TEST DIRTY IMAGES
    # Set in startup
    if test_imaging:
        execfile(pipepath + 'imaging_pipeline/EVLA_pipe_testimage_cont.py')
